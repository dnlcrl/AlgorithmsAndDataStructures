 ...
 * effettuare una semplice ricerca (di elemnti "docenti") su file 
 * di tipo corso.dtd.
 *
 */
...
public class LookupHandler extends org.xml.sax.helpers.DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
        ...
        } else if (qName.equals("docenti")) inDocenti=true;
    }

    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("docenti")) inDocenti=false;
        else if (qName.equals("nome") || qName.equals("cognome")) printChars = false;
    }

    public void characters(char[] ch, int start, int length) throws SAXException {
        if (printChars) System.out.print(String.valueOf(ch,start,length));
    }
